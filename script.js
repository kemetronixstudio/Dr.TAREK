...
function initQuiz(){
  ...
  function promptForQuizPassword(){
    ...
    const entered = window.askTextInput(`This quiz is protected. Enter password. If you do not know it, contact Dr. Tarek English`) || '';
    if (entered !== access.password){ alert('Wrong password. Contact Dr. Tarek English'); return false; }
    return true;
  }
