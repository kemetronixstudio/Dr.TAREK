...
function toggleCollapse(targetId, button){
  ...
  if (button){
    const key = shouldCollapse ? 'expandEditor' : 'collapseEditor';
    const nextText = translations[getLang()] && translations[getLang()][key] ? translations[getLang()][key] : (shouldCollapse ? 'Expand' : 'Collapse');
