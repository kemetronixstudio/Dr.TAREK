...
function initQuiz(){
  ...
  function promptForQuizPassword(){
    ...
    const entered = window.askTextInput(`This quiz is protected. Enter password. If you do not know it, contact Dr. Tarek 01032188008`) || '';
    if (entered !== access.password){ alert('Wrong password. Contact Dr. Tarek 01032188008'); return false; }
    return true;
  }
