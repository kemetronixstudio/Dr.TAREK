...
function initQuiz(){
  ...
  function clearQuizTimers(){ if (interval){ clearInterval(interval); interval = null; } if (autoAdvanceTimeout){ clearTimeout(autoAdvanceTimeout); autoAdvanceTimeout = null; } quizDeadlineTs = 0; try { if ('speechSynthesis' in window) speechSynthesis.cancel(); } catch(e){} }
