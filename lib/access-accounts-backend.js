...
const ALLOW_BUILTIN_ADMINS_FILE = String(process.env.ALLOW_BUILTIN_ADMINS_FILE || '').trim().toLowerCase() === 'true';
const ALLOW_PLAIN_PASSWORDS = String(process.env.ALLOW_PLAIN_PASSWORDS || '').trim().toLowerCase() === 'true';
